...
{
    public partial class UC_superAdminDashBoard : UserControl
    {
        public UC_superAdminDashBoard()
        {
            InitializeComponent();
        }

        //Update exiting information
        ...
        private void UC_superAdminDashBoard_Load(object sender, EventArgs e)
        {
